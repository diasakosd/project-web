...
$offer = "SELECT full_name AS Fullname, phone AS Telephone, time_created AS Created, category AS Category, item AS Item, quantity AS Quantity FROM citizens 
...
$request = "SELECT full_name AS Fullname, phone AS Telephone, time_created AS Created, category AS Category, item AS Item, quantity AS Quantity FROM citizens 
