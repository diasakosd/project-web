    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            try {
                ...
                //create markers for current rescuer
                ...
                for (let key in combinedRescuers.activeResc) {
                 ...
                 //create markers for inactive rescuers
    ...
    $.ajax({
        ...
        success: function(response2) {
            ...
            try {
                ...
                //create markers for base coordinates
        ...
        console.error("AJAX request error (Offers): ", status, error);
            ...
            function addMarkerIfNotExists(lat, lon, icon, layerGroup, coordinatesSet, type) {
                ...
                if (!coordinatesSet.has(coordinates)) {
                    ...
                    if (type === 'offerYes') {
                        const details = ballonDetailsOffT.shift(); 
                        title = 'Offer Taken';
                        ...
                        const details = ballonDetailsOffW.shift(); 
                        title = 'Offer Waiting';
                        ...
                        const details = ballonDetailsRegT.shift(); 
                        title = 'Request Taken';
                        ...
                        const details = ballonDetailsRegW.shift(); 
...
$.ajax({
    ...
    success: function(response) {
        ...
        try {
            ...
            //create markers for Requests(yes)
            ...
            //create markers for Requests(no)
