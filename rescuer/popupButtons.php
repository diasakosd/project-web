...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($actionType == 'offer') {
        ...
        if ($result) {
            echo json_encode(array('success' => 'citizen_offer updated successfully!'));
        } else {
            echo json_encode(array('error' => 'ERROR in offer taken: ' . mysqli_error($conn)));
        }
        ...
        if ($result2) {
            echo json_encode(array('success' => 'citizen_request updated successfully!'));
        } else {
            echo json_encode(array('error' => 'ERROR in request taken: ' . mysqli_error($conn)));
        }
    }
